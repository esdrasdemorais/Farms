...
function updateConfig(config) {
  ...
  config.verbose = config.verbose || argv.verbose; // Setup logger *before* config validation (because validations may use logger to print warnings)
...
function commandServer() {
  ...
  verbose('Webpack config:', compiler.options); // Show message when webpack is recompiling the bundle
